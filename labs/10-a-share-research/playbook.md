...
```powershell
.\.venv\Scripts\python.exe labs/10-a-share-research/report_cli.py
.\.venv\Scripts\python.exe labs/10-a-share-research/report_cli.py --short 5 --long 10
```
